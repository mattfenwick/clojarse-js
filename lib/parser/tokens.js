...
var _reserved = node('reserved',
    ...
    symbol = seq2R(_checks, alt(_reserved, _symbol));
...
var number = seq2R(bind(C.get, function(xs) {console.log('rest: ' + JSON.stringify([xs])); return C.pure();}),
                   alt(end(integer), end(float), end(ratio)));
